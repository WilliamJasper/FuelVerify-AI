...
const DashboardBBL = () => {
    ...
    const totalAmount = result?.summary?.previous_balance 
        ? parseFloat((result.summary.previous_balance || '').replace(/,/g, '')) || 0
        ...
        <div className="min-h-screen bg-[#F8FAFC] text-slate-900 font-sans pb-20 selection:bg-blue-100">
            ...
            >
                ...
                <SummaryCards
                    ...
                    amountLabel="สรุปค่าใช้จ่ายงวดที่ผ่านมา"
                    amountSublabel="ผลรวมค่าใช้จ่ายจากทุกบัตร"
                />
